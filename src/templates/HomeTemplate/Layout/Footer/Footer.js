            ...
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium">Hệ thống rạp</p>
                        <ul>
                            {arrHeThongRap?.map((tenHeThong,index)=>{
                                return (
                                    <li className='my-4 flex items-center' key={index} >
                                        <img style={{width:'50px'}} src={tenHeThong.logo} alt={tenHeThong.logo}/>
                                        <a className='ml-4' href='/'>{tenHeThong.maHeThongRap}</a>
                                    </li>
                                )
                            })}
                        </ul>
